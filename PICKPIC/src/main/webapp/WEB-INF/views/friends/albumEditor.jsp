...
<nav class="navbar topnav" id="myTopnav">
   <div class="container-fluid">
      <ul class="nav navbar-nav">
         <li id="alldelete_btn"><a href="#">전체 삭제</a></li>
...
<div id="filter_list" >
   <div class="container-fluid noMnP scroll_inline box" >
         ...
         <div class=" card-a cssco cssco--none card_hover" >
            ...
            <div class=" card-a cssco cssco--c1 card_hover" id="filterIndex" onclick="filterOn(this)">
            ...
            <div class=" card-a cssco cssco--f2 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />
               <div class="ovrly"></div>
                <span class="name_text">
                  F2
            ...
            <div class=" card-a cssco cssco--g3 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />              
               <div class="ovrly"></div>
                <span class="name_text">
                  G3
             ...
             <div class=" card-a cssco cssco--p5 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />
               <div class="ovrly"></div>
                <span class="name_text">
                  P5
             ...
             <div class=" card-a cssco cssco--lv3 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />
               <div class="ovrly"></div>
               <span class="name_text">
                  LV3
            ...
            <div class=" card-a cssco cssco--b5 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />
               <div class="ovrly"></div>
               <span class="name_text">
                  B5
            ...
            <div class=" card-a cssco cssco--a6 card_hover" id="filterIndex" onclick="filterOn(this)">
               <img src="<c:url value='/resources/images/filter/filter_default.jpg'/>" />
               <div class="ovrly"></div>	
               <span class="name_text">
                  A6
...
<!-- 모달창 열고 닫기 -->
                              ...
                              function(i, file) {
                                 ...
                                 reader.onload = function(e) {
                                    var template = '<div class="col-lg-2 col-md-4 col-sm-6 noMnP" id="div_'+index+'" >'
                                          ...
                                          + '<button type="button" class="btn btn-default tgbtn" id="'
                                          + index
                                          + '" onclick="javascript:selectItem(this)">선택</button>'
                                          + '</div></div></div>'
                                          + '</div></div>';
                                    idCount[index] = index;
                                     console.log(idCount[index]);
                                    index++;
   ...
   function selectItem(item) {
	  ...
	  $(item).html() == '해제' ? $('div[id=photo_wrap_'+currentIndex+']').css('box-shadow', '5px 5px 5px #c9e3f7') : $('.photo_wrap').css('box-shadow', '') ;     
   ...
   function deleteItem(item) {
      ...
      idCount.splice(currentIndex,1);
      console.log(idCount);
   }
   
   /* 전체삭제 */
   $("#alldelete_btn").click(function() {
	   $('#preview').empty();
	   idCount=[];
	 	index=1; 
	});
