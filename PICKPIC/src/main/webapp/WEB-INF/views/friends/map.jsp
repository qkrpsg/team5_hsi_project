...
.category .ico_comm {
	...
	height: 26px;
	background:
		url('http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/category.png')
		no-repeat;
}
...
<body>
	...
	<div id="mapwrap">
		...
		<div class="category">
			<ul>
				<li id="coffeeMenu" class="coffee" onclick=""><span
				...
				<li id="Menu"><span class="ico_comm ico_carpark"></span> test
				</li>
			</ul>
		</div>
	</div>
	...
	<script>
		...
		function setMarker(lat, lng, content) {
			...
			var marker = new daum.maps.Marker({
				...
				clickable : true
			// 마커를 클릭했을 때 지도의 클릭 이벤트가 발생하도록 설정합니다
			});
