...
<script>
	$(function() {
		...
		$('.kyk').click(
				function() {
					console.log('번호 잘 담고있니', $(this).parent().parent().find(
							'.ho').find('#cch').val());
					...
					$.ajax({
						...
						data : {
							q_index : $(this).parent().parent().find('.ho')
									.find('#cch').val(),
							aq_content : $(this).parent().parent().find('.how')
									.val(),
							'_csrf' : '${_csrf.token}'
						},
						dataType : 'text',
						...
						function() {
							...
							$
									.ajax({
										...
										data : {
											q_index : $(this).parent().parent()
													.find('.hi').find('#cch')
													.val(),
											aq_content : $(this).parent()
													.parent().find('.ha').val(),
									...
									<div class="box-body">
										<div class="post clearfix">
											...
											<p style="font-size: 15px;">
												<br /> <span
													style="font-weight: bold; font-size: 15px; margin-bottom: 2%">내용:</span>&nbsp;&nbsp;
												${item.Q_CONTENT }<br />
											</p>
											<c:if test="${empty item.AQ_CONTENT }" var="Empty">
												<div class="form-group margin-bottom-none">
													<div class="col-sm-1" style="">
														<img
															src="<c:url value='/resources/images/question.jpg'/> "
															class="sa">
													</div>
											...
											<c:if test="${not Empty }">
												<div class="form-group margin-bottom-none">
													...
													<div class="col-sm-1" style="margin-top: 6px;">
														<button type="submit"
															class="btn btn-danger pull-right btn-block btn-sm kyk"
