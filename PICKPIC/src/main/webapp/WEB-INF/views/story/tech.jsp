...
.dropdown-button {
		...
		.dropdown:hover .dropdown-button { background-color: #00BFFF; }
.search{
width:100px;
height: 40px;
...
<div class="col-md-12" style="margin-left: 20%;margin-right: 20%;margin-top: 4%">
<p class="text1">PICKPIC에 등록되어 있는 사진들(총 ****개)</p>
</div> 
<div class="col-md-12">
<hr style="border:solid 2px #708090" />
</div>
<div class="col-md-12 " style="margin-left: 30%; margin-right: 20%;margin-top: 2%;margin-bottom: 2%;">
<div class="col-md-offset-1 col-md-4" style="z-index: 3" >
<div class="dropdown">
