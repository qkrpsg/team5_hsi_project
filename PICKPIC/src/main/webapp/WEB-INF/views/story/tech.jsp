...
<div class="col-md-5"> 
<button class="profile">프로필 수정</button><button class="profile">옵션</button>
<br/>
<img src="<c:url value='/resources/images/pro.jpg'/>"class="prosa" >

</div>

<div class="col-md-12" style="margin-bottom: 1%;">
<button class="probutton">픽보관함</button><button class="probutton">게시글</button><button class="probutton">루트</button><button class="probutton">필터</button>
