...
<div class="row" style="margin-top: 5%;margin-left: 20%;margin-right: 20%" >
<div class="col-md-12" style="padding-left:7%;padding-top: 7%;padding-right: 20% ">
<div class="col-md-7" style="padding-top: 8%;">
<p style="font-size:40px; ">썸이 끝났다</p>
<p class="text1">싸움의 시작, 피크픽</p>
<p style="font-size:20px;">지금 사진 혼자 찍고 계신가요? <br/>
피크픽을 시작하세요!<br/>
피크픽은 연인과 더 사직을 찍을 수 있고 <br/>
손쉽게 저장할수 있는 어플이다.
</p>
...
<button class="appbutton"><img src="<c:url value='/resources/images/app4.jpg'/>" style="border-radius: 20px;"></button>
</div>
