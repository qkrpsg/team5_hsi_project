...
<div class="col-md-12">
<img src="<c:url value='/resources/images/crew1.jpg'/>" class="crewsa">
...
<div class="col-md-12">
<div class="col-md-6"  ">
<img src="<c:url value='/resources/images/crew7.jpg'/>" class="crewsa">
<p class="text1">고우진(32)</p>
<p class="text1">bbbbbb</p>
<p class="text2">내용</p>
</div>
<div class="col-md-6" >
<img src="<c:url value='/resources/images/crew3.jpg'/>" class="crewsa">
...
<div class="col-md-12">
<div class="col-md-6">
<img src="<c:url value='/resources/images/crew4.jpg'/>" class="crewsa">
<p class="text1">이용수(27)</p>
<p class="text1">bbbbbb</p>
<p class="text2">내용</p>
</div>
<div class="col-md-6">
<img src="<c:url value='/resources/images/crew5.jpg'/>" class="crewsa">
...
<div class="col-md-12">
<div class="col-md-6">
<img src="<c:url value='/resources/images/crew6.jpg'/>" class="crewsa">
<p class="text1">한주영(26)</p>
<p class="text1">bbbbbb</p>
<p class="text2">내용</p>
</div>
<div class="col-md-6">
<img src="<c:url value='/resources/images/crew2.jpg'/>" class="crewsa">
