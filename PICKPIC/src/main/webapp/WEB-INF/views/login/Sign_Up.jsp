...
<div class="l_pkp_all_wrap">
	<div class="l_pkp_sub_wrap">
		...
		<div class="row">
			<!--  -->
			<form role="form" action='<c:url value="/user/sign_process.pic"/>'
				method="post">
				...
				<div class="form-group">
					...
					<label for="ppu_id">아이디</label> <input type="text"
						...
						placeholder="아이디를 입력해 주세요" data-validation="required"> <input
						type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
					<a class="id_check btn btn-info" style="margin-top: 10px;">중복체크</a><span
						id="hi" style="color: red;"></span>
				</div>

				<div class="form-group">
					<label for="ppu_password">비밀번호</label> <input type="password"
						class="form-control" name="ppu_password" id="ppu_password"
						placeholder="비밀번호를 입력해주세요" data-validation="required">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label for="ppu_name">이름</label> <input type="text"
						...
						placeholder="이름 입력해 주세요" data-validation="required">
				</div>


				<div class="form-group">
					<label for="ppu_nickname">닉네임</label> <input type="text"
						class="form-control" name="ppu_nickname" id="ppu_nickname"
						placeholder="닉네임을 입력해 주세요" data-validation="required">
				</div>
