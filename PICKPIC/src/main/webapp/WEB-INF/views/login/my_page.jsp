			...
			<div class="col-md-10 col-lg-8">
				<div class="intro">
					<div class="profile-img">
						<img class="pr_img" src='${user.ppa_profile_path }' alt="x">
					</div>
					...
					<ul class="follow2" id="mypage_sub">
						<li>
							...
							<a href="javascript:void(0);" onclick="sub_spread('place')" id="place" style="color: #2c343b;">
							<font style="vertical-align: inherit;">픽플레이스</font></a>
						</li>
						<li>
							<h6>
								<font class="index_load" style="vertical-align: inherit; color: #4883ff">${user.totalroad }</font>
							</h6> 
							<a href="javascript:void(0);" onclick="sub_spread('load')" id="load" style="color: #2c343b;">
							<font style="vertical-align: inherit;">픽로드</font></a>
						</li>
						<li>
							<h6>
								<font style="vertical-align: inherit; color: #4883ff">0</font>
							</h6> 
							<a href="javascript:void(0);" onclick="sub_spread('mystorage')" id="mystorage" style="color: #2c343b;">
							<font style="vertical-align: inherit;">보관함</font></a>
						</li>
						<li>
							<h6>
								<font class="index_myfilter" style="vertical-align: inherit; color: #4883ff">${user.totalfilter }</font>
							</h6> 
							<a href="javascript:void(0);" onclick="sub_spread('myfilter')" id="myfilter" style="color: #2c343b;">
							<font style="vertical-align: inherit;">보유 필터</font></a>
						</li>
					</ul>
				</div>
				<!-- intro -->
...
<section class="pricing-tables sub_items">
	<div class="container">
		<div class="grid" style="position: relative; height: 885px;"></div>
	</div>
</section>
