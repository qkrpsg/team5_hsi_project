...
<div class="col-md-offset-4 col-md-4" style="padding:1%;background-color: #1183db;border-bottom: solid 1px #87CEFA;border-top:solid 1px #87CEFA ">
        ...
        <span style="font-size: 15px;margin-bottom: 1%">작성자: ${list.ppa_nickname } </span><br/><br/>
           <span style="font-size: 15px" > 제목: ${list.tb_title } </span>
...
<c:if test="${empty list.tb_content }" var="isEmpty">
...
<div class="col-md-offset-4 col-md-4" style="border-bottom: solid 1px #db11bd;border-top:solid 1px #db11bd;padding-top:1%;padding-bottom:1%;background-color: #11dbaf;">
     <img src="<c:url value='/resources/images/reply.png'/>" class="sa"><span style="font-size: 23px;">&nbsp; ${list.tb_content }</span><span style="font-size: 15px;color:#778899;float:right ">답변 등록일: ${list.tb_post_date }</span>
</div>
</c:if>
