...
<%@ taglib  prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <!-- Logo -->
    <a href="<c:url value='/PICKPIC/admin/home.pic'/>" class="logo">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
      	<li id="home"><a href="<c:url value='/PICKPIC/admin/home.pic'/>"><i class="fa fa-home"></i> <span>HOME</span></a></li>
        <li class="header">Administration List</li>
        <!-- Optionally, you can add icons to the links -->
        <li id="users"><a href="<c:url value='/PICKPIC/admin/users.pic'/>"><i class="fa fa-fw fa-group"></i> <span>회원관리</span></a></li>
        <li id="post"><a href="<c:url value='/PICKPIC/admin/post.pic'/>"><i class="fa fa-navicon"></i> <span>게시글관리</span></a></li>
        <li id="qna"><a href="<c:url value='/PICKPIC/admin/qna.pic'/>"><i class="fa fa-question"></i> <span>문의관리</span></a></li>
        <li><a href="#"><i class="fa fa-map-signs"></i> <span>루트관리</span></a></li>
        <li id="attraction"><a href="<c:url value='/PICKPIC/admin/attraction.pic'/>"><i class="fa fa-map"></i> <span>명소관리</span></a></li>
