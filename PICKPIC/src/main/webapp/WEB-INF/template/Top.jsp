	...
	<div class="menu_all_wrap_position">
		<div class="main_menu_wrap">
			<div class="logo col-md-2">
				<a href="<c:url value='/admin/home.pic'/>"> <img id="top_logo"
				...
				<div class="menu_login_in">
					<nav class="menu_wrap col-md-9">
						<ul>
							...
							<li class="col-md-3"><a
								href="<c:url value='/user/map.pic'/>">피크픽 프렌즈</a></li>
					...
					<div class="login_wrap col-md-3">
						<ul>
							<sec:authorize access="isAnonymous()">
								...
								<li><a href="<c:url value='/user/sign_up.pic'/>">SIGN
										UP</a></li>
							</sec:authorize>
							<sec:authorize access="isAuthenticated()">
								<li><a href="<c:url value='/user/myPage.pic'/>"><sec:authentication
											property="principal.username" /> 님 <span></span></a></li>
