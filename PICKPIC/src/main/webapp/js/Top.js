...
$(function(){
	...
	/*for(var i=0;i<17;i++){
		grid_item[i].innerHTML = '<img src="img/'+i+1+'.jpg" >';
	}*/
	
	
	
	/*grid[0].innerHTML = '<div class="grid-item" ><img src="img/1.jpg" ></div><div class="grid-item" ><img src="img/2.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/3.jpg" ></div><div class="grid-item" ><img src="img/4.jpg" ></div>'
		...
		+'<div class="grid-item" ><img src="img/10.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/11.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/12.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/13.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/14.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/15.jpg" ></div>'
		+'<div class="grid-item" ><img src="img/16.jpg"></div>'
	  ...
	  $(".menu_wrap ul li").mouseenter(function(){
	    ...
	    $('.button-container-1').click(function(e){
	    	if($('#mobile-nav').css("left") == "0px"){
	    		...
	    		$('#mobile-nav').stop().animate({left:"-500px"},500,function(){
	    			$('.menu_all_wrap_position').css({height:"50px"});
	    		});
	    	}else{
	    		$('.menu_all_wrap_position').css({height:"940px"});
	    		$('#mobile-nav').stop().animate({left:"0px"},500);
	    	}
	    });
